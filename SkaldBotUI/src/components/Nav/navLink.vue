<template>
    <div>
        ...
        <router-link class="border-transparent text-white hover:bg-hover group flex items-center px-3 py-2 text-sm font-medium border-l-4 rounded-md" :to="to" v-if="sideNavLink" v-on:click.native="onClick"><slot></slot></router-link>
    </div>
</template>
