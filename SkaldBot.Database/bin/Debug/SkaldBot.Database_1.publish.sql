/*
Deployment script for SkaldBot.Database
...
GO
:setvar DatabaseName "SkaldBot.Database"
:setvar DefaultFilePrefix "SkaldBot.Database"
...
GO
PRINT N'Creating [dbo].[CodeModules]...';
...
CREATE TABLE [dbo].[CodeModules] (
    ...
    CONSTRAINT [PK_CodeModules] PRIMARY KEY CLUSTERED ([id] ASC)
);


GO
PRINT N'Creating [dbo].[CodeStations]...';
...
GO
PRINT N'Creating [dbo].[CodeSystems]...';
